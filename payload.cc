...
private:
	...
	unsigned long m_ip_addr, m_files_shared, m_kilo_shared;
public:
...
private:
	unsigned long m_file_index, m_file_size;
	string m_file_name;
public:
...
private:
	unsigned short m_num_hits, m_port;
	unsigned long m_ip_addr, m_speed;
...
private:
	char m_servent_id[16];
	unsigned long m_file_index, m_ip_addr;
	unsigned short m_port;
public:
